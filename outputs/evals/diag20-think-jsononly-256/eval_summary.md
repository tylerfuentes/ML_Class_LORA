...
- contains_think_rate: `0.0000`
- malformed_think_tag_rate: `0.0000`
- json_after_reasoning_text_rate: `0.0500`
...
- `thinking` base accuracy=`0.6500` adapter accuracy=`0.8500` delta=`+0.2000`
- `thinking` base macro_f1=`0.7116` adapter macro_f1=`0.8521` delta=`+0.1405`
